...
def main():
    try:
        ...
        cameraProcess = threading.Thread(target = manageCamera)
        moveProcess = threading.Thread(target = manageArm)
        cameraProcess.daemon = True
        moveProcess.daemon = True
        # threads = [cameraProcess, moveProcess]
        threads = [moveProcess, cameraProcess]
